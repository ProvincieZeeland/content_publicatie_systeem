...
//        public async Task<string> GetFileUrlAsync(string siteId, string driveItemId)
//        {
//            _ = _graphClient ?? throw new NullReferenceException("Graph has not been initialized");
...
//        public async Task<ListItem?> GetLisItemAsync(string siteId, string listId, string listItemId)
//        {
//            _ = _graphClient ?? throw new NullReferenceException("Graph has not been initialized");
...
//        public async Task<DriveItem?> PutFileAsync(string siteId, string driveItemId, MemoryStream stream)
//        {
//            _ = _graphClient ?? throw new NullReferenceException("Graph has not been initialized");
...
//        public async void DeleteFileAsync(string siteId, string driveItemId)
//        {
//            _ = _graphClient ?? throw new NullReferenceException("Graph has not been initialized");
